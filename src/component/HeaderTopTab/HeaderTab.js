    ...
    <View style={{flex: 1}}>
      ...
      <View style={{flex: 1}}>
        <Tab.Navigator tabBar={props => <MyTabBar {...props} />}>
          <Tab.Screen name="Home" component={HeaderHomeTab} options={{tabBarLabel: 'Home'}} />
          <Tab.Screen name="Settings" component={HeaderSettingTab} options={{tabBarLabel: 'Settings'}}/>
          <Tab.Screen name="Chat" component={HeaderSettingTab} options={{tabBarLabel: 'Chat'}}/>
          <Tab.Screen name="A"component={HeaderSettingTab} options={{tabBarLabel: 'A'}}/>
          <Tab.Screen name="B" component={HeaderSettingTab} options={{tabBarLabel: 'B'}}/>
          <Tab.Screen name="C" component={HeaderSettingTab} options={{tabBarLabel: 'C'}}/>
        </Tab.Navigator>
      </View>
      <View style={styles.contaiterButton}>
        <View style={styles.boxButton}>
          ...
          <TouchableOpacity
            ...
            style={styles.btnBottomCloseRecruitment}>
        ...
        <DraggableBottomView active={show1} hideBottomSheet={setShow1}>
          <View style={{height: '100%'}}>
            ...
            <View style={styles.BottomBody}>
              <Text>
                "metime", "aaa"{'\n'}
                Do you want to decide as that user?
              </Text>
            </View>
            <View style={styles.BottomSheetButton}>
              <TouchableOpacity
